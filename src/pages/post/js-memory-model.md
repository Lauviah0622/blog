---
title: What JS is or not？ Ep.2 Memory- model
...
身為吃 JS 飯的工程師，雖然有點不太客觀。但能夠把一個動態型別、並且不需要事前編譯的語言做到這樣的執行效率，可以說是工程奇蹟了。但這個奇蹟並非來的理所當然。從一開始被創造，然後跟著瀏覽器發展，又外溢到其他領域。 JS 創造了與眾不同的語言文化：一個野生的文化：固然混亂，但又有跡可循。
